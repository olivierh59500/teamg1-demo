...
import (
	...
	demo "teamg1-demo/dck"
)

func main() {
	config := video.Config{Output: "teamg1-demo.mp4", Title: "TEAMG1", Width: 768, Height: 540, FPS: 60, TPS: 60, SampleRate: 48000, Duration: 3 * time.Minute}
